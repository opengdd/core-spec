...
- `mood.paper-quiet`: A game drawn on scrap paper between two people who happen to be nearby.
- `colors.mark-ink`: One shared ink; the players stay distinguishable by mark shape alone.
